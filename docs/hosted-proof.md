...
- Generated proof state is written to `frontend\.hosted-proof\hosted-proof-state.json`.
...
Do not commit or print `frontend\.hosted-proof\hosted-proof-state.json`; it contains generated proof passwords.
