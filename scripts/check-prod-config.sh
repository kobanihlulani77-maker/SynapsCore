...
backend_db_host="$(require_value "$BACKEND_FILE" "DB_HOST")"
backend_db_name="$(require_value "$BACKEND_FILE" "DB_NAME")"
backend_db_user="$(require_value "$BACKEND_FILE" "DB_USER")"
backend_db_password="$(require_value "$BACKEND_FILE" "DB_PASSWORD")"
backend_redis_host="$(require_value "$BACKEND_FILE" "REDIS_HOST")"
...
backend_ddl_auto="$(require_value "$BACKEND_FILE" "JPA_DDL_AUTO")"
