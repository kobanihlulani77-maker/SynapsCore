# SynapseCore Docs Index

This index links the main product, architecture, runbook, proof, and operator documents in the repository.
...
- [scenario-lifecycle-phase-7-escalation-owner-sla.md](evidence/scenario-lifecycle-phase-7-escalation-owner-sla.md)
