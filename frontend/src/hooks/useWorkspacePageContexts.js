...
export default function useWorkspacePageContexts({
  ...
  return {
    ...
    authenticatedAppProps: {
      ...
      auditContext: { isAuthenticated, isAuditPage, snapshot, systemIncidents, pendingReplayCount, recentBusinessEvents, recentAuditEntries, selectedAuditTrace, setSelectedTraceEntryKey, formatCodeLabel, formatTimestamp, navigateToPage, pageLoading: pageState.loading, pageError: pageState.error },
