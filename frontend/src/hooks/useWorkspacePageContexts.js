...
export default function useWorkspacePageContexts({
  ...
  const {
    ...
    isAuthenticated,
    summary,
    pageFreshness: pageState.freshness,
    degradedSources: pageState.degradedSources,
    lastSuccessfulSnapshotAt: pageState.lastSuccessfulAt,
    snapshot,
    catalogState,
    warehouseOptions,
    fulfillmentOverview,
  ...
  return {
    ...
    authenticatedAppProps: {
      ...
      enabledConnectorCount,
      snapshot,
      dashboardContext: { isAuthenticated, isDashboardPage, warehouseOptions, snapshot, fulfillmentOverview, activeAlerts, urgentActions, navigateToPage, setSelectedAlertId, setSelectedRecommendationId, setSelectedScenarioId, pendingApprovalScenarios, runtime, systemIncidents, utilityTimeline, formatCodeLabel, formatTimestamp, formatBuildValue, getRuntimeStatusClassName, enabledConnectorCount, pendingReplayCount, pageLoading: pageState.loading, pageError: pageState.error, pageFreshness: pageState.freshness, degradedSources: pageState.degradedSources, lastSuccessfulSnapshotAt: pageState.lastSuccessfulAt, catalogState, canManageTenantAccess, accessAdminUsers, signedInSession, signedInRoles, connectionState, liveClockLabel, pageStatus: pageStatusMap.dashboard },
      alertsContext: { isAuthenticated, isAlertsPage, activeAlerts, selectedAlertId, setSelectedAlertId, formatTimestamp, pageLoading: pageState.loading, pageError: pageState.error },
      recommendationsContext: { isAuthenticated, isRecommendationsPage, snapshot, recommendationNow, recommendationSoon, recommendationWatch, selectedRecommendationId, setSelectedRecommendationId, formatTimestamp, pageLoading: pageState.loading, pageError: pageState.error },
      ordersContext: { isAuthenticated, isOrdersPage, snapshot, fulfillmentOverview, selectedOrderId, setSelectedOrderId, summary, warehouseOptions, signedInRoles, currency, formatCodeLabel, formatRelativeHours, formatTimestamp },
      inventoryContext: { isAuthenticated, isInventoryPage, snapshot, selectedInventoryId, setSelectedInventoryId, lowStockInventory, highRiskInventory, fastMovingInventory, warehouseOptions, signedInRoles, signedInWarehouseScopes, hasWarehouseScope, fetchJson, fetchSnapshot, formatCodeLabel, formatRelativeHours },
      catalogContext: { isAuthenticated, isCatalogPage, catalogState, catalogForm, setCatalogForm, selectedCatalogProductId, setSelectedCatalogProductId, saveCatalogProduct, importCatalogProducts, resetCatalogForm, canManageTenantAccess, pageLoading: pageState.loading, pageError: pageState.error },
      locationsContext: { isAuthenticated, isLocationsPage, warehouseOptions, snapshot, fulfillmentOverview, activeAlerts, formatCodeLabel, signedInWarehouseScopes, signedInRoles, pageLoading: pageState.loading, pageError: pageState.error },
      fulfillmentContext: { isAuthenticated, isFulfillmentPage, delayedFulfillments, fulfillmentOverview, warehouseOptions, formatCodeLabel, formatRelativeHours, getFulfillmentStatusClassName, enabledConnectorCount, snapshot, pendingReplayCount, signedInRoles, pageLoading: pageState.loading, pageError: pageState.error },
      ...
      scenarioHistoryContext: { isAuthenticated, isScenarioHistoryPage, scenarioHistoryItems, selectedHistoryScenario, setSelectedScenarioId, formatCodeLabel, formatTimestamp, scenarioDecisionContext, pageLoading: pageState.loading, pageError: pageState.error },
      approvalsContext: { isAuthenticated, isApprovalsPage, pendingApprovalScenarios, approvedScenarios, rejectedScenarios, overdueScenarios, selectedApprovalScenario, setSelectedScenarioId, formatCodeLabel, formatTimestamp, snapshot, scenarioDecisionContext, signedInSession, signedInWarehouseScopes, hasWarehouseScope },
      escalationsContext: { isAuthenticated, isEscalationsPage, snapshot, systemIncidents, escalatedScenarios, selectedEscalationScenario, setSelectedScenarioId, formatCodeLabel, formatTimestamp, getIncidentStatusClassName, scenarioDecisionContext, pageLoading: pageState.loading, pageError: pageState.error },
      integrationsContext: { isAuthenticated, isIntegrationsPage, snapshot, selectedIntegrationConnectorId, setSelectedIntegrationConnectorId, enabledConnectorCount, pendingReplayCount, systemIncidents, navigateToPage, formatCodeLabel, formatTimestamp, getImportStatusClassName, signedInRoles },
      ...
      auditContext: { isAuthenticated, isAuditPage, snapshot, systemIncidents, pendingReplayCount, recentBusinessEvents, recentAuditEntries, selectedAuditTrace, setSelectedTraceEntryKey, formatCodeLabel, formatTimestamp, navigateToPage, pageLoading: pageState.loading, pageError: pageState.error, signedInWarehouseScopes },
      usersContext: { isAuthenticated, isUsersPage, accessAdminOperators, accessAdminUsers, accessAdminState, workspaceAdmin, selectedAccessSubject, setSelectedAccessSubjectKey, formatCodeLabel, navigateToPage, canManageTenantAccess, pageError: pageState.error },
      settingsContext: { isAuthenticated, isSettingsPage, workspaceAdmin, accessAdminState, canManageTenantAccess, workspaceSettingsForm, setWorkspaceSettingsForm, workspaceSecurityForm, setWorkspaceSecurityForm, workspaceWarehouseCreateForm, setWorkspaceWarehouseCreateForm, saveWorkspaceSettings, saveWorkspaceSecuritySettings, selectedWorkspaceWarehouse, selectedWorkspaceWarehouseDraft, selectedWorkspaceConnector, selectedWorkspaceConnectorDraft, selectedWorkspaceConnectorOwnerOptions, setSelectedWorkspaceWarehouseId, setSelectedWorkspaceConnectorId, setWorkspaceWarehouseDrafts, setWorkspaceConnectorDrafts, saveWorkspaceWarehouse, saveWorkspaceConnectorSupport, createWorkspaceWarehouse, retireWorkspaceWarehouse, reactivateWorkspaceWarehouse, formatCodeLabel, integrationValidationPolicies, integrationTransformationPolicies, signedInSession, pageError: pageState.error },
      profileContext: { isAuthenticated, isProfilePage, passwordChangeRequired, passwordRotationRequired, activeAlerts, pendingApprovalScenarios, systemIncidents, signedInSession, signedInRoles, signedInWarehouseScopes, signedInSessionExpiresAt, signedInPasswordExpiresAt, formatCodeLabel, formatTimestamp, passwordChangeState, setPasswordChangeState, changeSignedInPassword, signOutOperator, authSessionState, navigateToPage, canManageTenantAccess, pageError: pageState.error },
