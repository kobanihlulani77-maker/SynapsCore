...
export default function useWorkspacePageContexts({
  ...
  return {
    ...
    authenticatedAppProps: {
      ...
      enabledConnectorCount,
      snapshot,
      dashboardContext: { isAuthenticated, isDashboardPage, warehouseOptions, snapshot, fulfillmentOverview, activeAlerts, urgentActions, navigateToPage, setSelectedAlertId, setSelectedRecommendationId, setSelectedScenarioId, pendingApprovalScenarios, runtime, systemIncidents, utilityTimeline, formatCodeLabel, formatTimestamp, formatBuildValue, getRuntimeStatusClassName, enabledConnectorCount, pendingReplayCount, pageLoading: pageState.loading, catalogState, canManageTenantAccess, accessAdminUsers, signedInSession, signedInRoles, connectionState, liveClockLabel, pageStatus: pageStatusMap.dashboard },
